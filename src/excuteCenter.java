...
import P51TO100.P91.P91;
import P51TO100.P93.P93;
...
//        TreeNode root = new P7().reConstructBinaryTree(new int[]{1,2,4,7,3,5,6,8},new int[] {4,7,2,1,5,3,8,6});
        ...
        sList.addAll(Arrays.asList(new String[]{"hot","dot","dog","lot","log","hit","cog"}));
        Collections.sort(sList);
        System.out.println("answer:"+new P128().longestConsecutive(new int[]{1,3,5,2,4}));
