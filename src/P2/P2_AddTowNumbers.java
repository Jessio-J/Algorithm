package P2;//给出两个 非空 的链表用来表示两个非负的整数。其中，它们各自的位数是按照 逆序 的方式存储的，并且它们的每个节点只能存储 一位 数字。
//
 ...
 * public class P2.ListNode {
 *     int val;
 *     P2.ListNode next;
 *     P2.ListNode(int x) { val = x; }
 * }
 */
...
//        l.next = new P2.ListNode(sum);
        return head;
    }

    public static void main(String[] args){
        ListNode l1 = new ListNode(9);
//        l1.next = new P2.ListNode(8);
